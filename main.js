...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (missionsGrid) {
        ...
        const MISSIONS = [
            ...
            { titre: 'Architecture réseau — RIE & infrastructure site', desc: 'Découverte de l\'infrastructure réseau DGFIP : RIE (Réseau Interministériel de l\'État) réseau privé commun à tous les ministères, accès internet via VPN. Identification des LTI (Local Technique Immeuble) et LTE (Local Technique d\'Étage) gérés par le service SYL, câblage VD/DP, baies de brassage et adressage IP par switch.', tag: 'stage', cat: 'patrimoine', ctx: 'Stage DGFIP — CID Versailles V12' },
        ];
