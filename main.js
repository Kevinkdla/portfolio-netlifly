...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (missionsGrid) {
        ...
        const MISSIONS = [
            ...
            { titre: 'Préparation des accès agents — Samba4 (BaoS) & Agenti', desc: 'Configuration des comptes en vue de l\'arrivée de nouveaux agents. Affectation au GPO du site de travail via BaoS (serveur Samba4 DGFIP, équivalent open source d\'Active Directory). Placement dans les répertoires partagés correspondant au service métier via Agenti (ex : Trésorerie Hospitalière).', tag: 'stage', cat: 'patrimoine', ctx: 'Stage DGFIP — CID Versailles V12' },
        ];
